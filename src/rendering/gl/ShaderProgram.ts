...
class ShaderProgram {
  ...
  attrTransform1: number; // transform matrix column 1  
  attrTransform2: number; // transform matrix column 2
  attrTransform3: number; // transform matrix column 3
  attrTransform4: number; // transform matrix column 4
  attrUV: number;
